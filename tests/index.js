const { fDate, fTime, dateAmount, fNumber, JsonToXml, generateRandomString, toKebabCase, deepClone, bytesToSize, shuffleArray, isValidEmail, isStrongPassword, removeDuplicates, sortByProperty, objectToQueryString, truncateString, chunkArray, isVaildUrl, getDifferenceBetweenArrays, arrayIntersection, deepMerge, palindromeChecker, capitalize, toCamelCase, parseQueryString, flattenArray, arrayAverage, arraySum, levenshteinDistance, validateAgainstSchema, hexToRGB } = require("../lib/index");
...
const url = "https://www.google.com/?q=hello+world&test=123";
...
console.log(validateAgainstSchema(data, schema));
